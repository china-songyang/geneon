...
<div class="party">
           	  <div class="partay">
                <h1>公司简介</h1>
                <div class="more"><a href="<%=WebUtils.getLink("geneon.about", null)%>"><img src="images/more.png" width="44" height="13" /></a></div>
              </div>
                <div class="partbyy">
                	<div class="wz">
            ...
            <div class="party">
           	  <div class="partay">
                <h1>产品展示</h1>
                <div class="more"><a href="<%=WebUtils.getLink("geneon.product", null)%>"><img src="images/more.png" width="44" height="13" /></a></div>
              </div>
                <div class="partbyc">
                	<%
						...
						if (articles != null && !articles.isEmpty()) {
							...
							for (; i < articles.size() && i<5; ++i) {
								...
								%>
								<div class="cpa">
		                        	<div class="cpao"><a href="detail.jsp?cid=geneon.product&did=<%=did%>"><img src="<%=urlz %>" alt="" width="128" height="125" /></a></div>
		                            <h3><a href="detail.jsp?cid=geneon.product&did=<%=did%>"><%=title %></a></h3>
		                        </div>
								<%
							}
							%>
