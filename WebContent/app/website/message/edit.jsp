		...
		<form id="editForm"
			...
			<table class="table-form">
				...
				<tr>
					...
					<td><input id="receiveTime" type="text" name="receiveTime" class="easyui-datebox" type="text" value="${message.receiveTime}" ></input></td>
					<td></td>
				</tr>
				<tr>
					<td style="text-align:right">回复人:</td>
					<td><input id="receiveOperaterName" type="text" name="receiveOperaterName" type="text" value="${message.receiveOperaterName}"></input></td>
					<td></td>
				</tr>
